...
I build and own production systems end-to-end — from architecture and APIs to deployment and scaling. Most of my work lives in the **TypeScript / Node.js / React** world, deployed on **Kubernetes** and **Google Cloud**.

- 🏦 Currently leading full-stack engineering on **FinTech platforms** running across **18 bank production environments** at **99.9% uptime**
- ⚡ Comfortable across the stack — REST APIs, microservices, event-driven systems, and the UI on top of them
- 🤖 Daily **AI-paired developer** — Claude Code, Cursor, and Copilot are part of how I ship
- 🧩 I like taking a loosely-defined problem, scoping it directly, and shipping a measurable outcome
...
**Backend:** Node.js · Express · NestJS · REST APIs · Microservices · Event-Driven Architecture
**Frontend:** React · React Native · Next.js · Redux
**Data & Messaging:** PostgreSQL · MongoDB · Redis · RabbitMQ · NATS
**Cloud & DevOps:** GCP (GKE, Cloud Run) · Kubernetes · Docker · Terraform · CI/CD
**AI-Paired:** Claude Code · Cursor · GitHub Copilot
...
<p>
  <a href="https://www.linkedin.com/in/areeb13">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:areeburrehman13@gmail.com">
    <img src="https://img.shields.io/badge/Email-EA4335?style=flat&logo=gmail&logoColor=white" />
  </a>
</p>
<!--
**H-Areeb/H-Areeb** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
